...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("dev.abdullahawan@gmail.com");
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(4,0,36,0.9585084033613446) 21%, rgba(0,212,255,1) 46%, rgba(71,9,121,0.8856792717086834) 67%)",
      }}
    >
